<div class="step">
    <h2 class="prt-center"><?php echo $this->settings->get_option('haus_step4', 'prt_settings_texts', 'Wie viele <b>Zimmer</b> hat das Haus?'); ?></h2>
    <h5 class="prt-center sub-title"><?php echo $this->settings->get_option('haus_step4_sub', 'prt_settings_texts', '(ohne Küche und Bad)'); ?></h5>
    <hr>
    <section class="data">
